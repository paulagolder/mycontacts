...
public class jswStyle
{
	...
	public Border getBorder()
	{
		...
		if (borderwidth > 0) return setLineBorder(bordercolor, borderwidth);
		else
			return null;
	...
	public Border getCellBorder()
	{
		...
		return setCellBorder(bordercolor, borderwidth);
		/*
	...
	public MatteBorder setCellBorder(Color col, int w)
	{
	...
	public Border setLineBorder(Color col, int w)
	{
	...
	public int getHorizontalAlign(int align)
	{
		if (styles.containsKey("horizontalAlign"))
				{
			String astyle =  styles.get("horizontalAlign");
			if (astyle.equals("LEFT")) return SwingConstants.LEFT;
			else if (astyle.equals("MIDDLE"))  return SwingConstants.CENTER;
			else if (astyle.equals("CENTER"))  return SwingConstants.CENTER;
