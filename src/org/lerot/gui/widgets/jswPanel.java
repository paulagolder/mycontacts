...
public abstract class jswPanel extends JPanel
{
	...
	public void applyStyles(JComponent label, jswStyle usestyles)
	{
		...
		if (label instanceof jswLabel)
		{
			...
			innerlabel.setBackground(styles.getColor("backgroundColor",
					Color.white));
			innerlabel.setHorizontalAlignment(styles.getHorizontalAlign(SwingConstants.LEFT));
		...
		} else if (label instanceof JLabel)
		{
			...
			((JLabel) label).setHorizontalAlignment(styles.getHorizontalAlign(SwingConstants.LEFT));
	...
	{
		jswStyle styles = jswStyles.getStyles("allstyles").getStyle(stylename);
	...
	private void setStyle(String stylename)
	{
		...
		jswStyle basestyle = jswStyles.getStyles("allstyles").getStyle(stylename);
